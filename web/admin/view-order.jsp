...
<head>
    ...
    <title>discipl!ne pro 后台管理 &#8211; 订单明细</title>
                                        ...
                                        <div class="woocommerce-order">
                                            <c:if test="${order.status!=0}">
                                                <p  lass="woocommerce-notice woocommerce-notice--success woocommerce-thankyou-order-received">
                                                    <c:if test="${order.status==1}">订单正在准备发货</c:if>
                                                    <c:if test="${order.status==2}">订单已发货</c:if>
                                                    <c:if test="${order.status==3}">订单已送达</c:if>
                                                    <c:if test="${order.status==5}">订单已逾期</c:if>
                                                </p>
                                            </c:if>
